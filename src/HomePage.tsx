...
export const HomePage:React.FC<{}> = () => (
    <>
        <div className="flex flex-row justify-evenly">
            <div className="text-slate-100 flex flex-col justify-evenly items-left max-w-lg">
            ...
            <div className="rounded-xl p-3 bg-white hover:bg-slate-800 duration-500">
                <Avatar variant="square" sx={{ width: 300, height:300, borderRadius: 10, }} src="profile.jpg">
                    Joey
                </Avatar>
            </div>
        </div>
        <div className="flex flex-wrap column place-content-center m-10 text-slate-100">
